...
INSERT INTO `anonymous_clazz` VALUES ('computer152','计算机152','四川省','电子科技大学','计算机学院','计算机应用与科学','2015-09-01','2019-06-30'),('software133','软工133','广东省','中山大学','软件学院','软件工程','2013-09-01','2017-06-30'),('test1','测试班级1','Tokyo','Tokyo_University','FBI','movies','2013-09-01','2019-06-30'),('tongji131','统计131','广东省','仲恺农业工程学院','计算科学学院','统计学','2013-09-01','2017-06-30'),('tongji132','统计132','广东省','仲恺农业工程学院','计算科学学院','统计学','2013-09-01','2017-06-30'),('tumu141','土木141','广东省','仲恺农业工程学院','城市建设学院','土木工程','2014-09-01','2018-06-30'),('xinji131','信计131','广东省','仲恺农业工程学院','计算科学学院','信息与计算科学','2013-09-01','2017-06-30'),('xinji132','信计132','广东省','仲恺农业工程学院','计算科学学院','信息与计算科学','2013-09-01','2017-06-30'),('xinji133','信计133','广东省','仲恺农业工程学院','计算科学学院','信息与计算科学','2013-09-01','2017-06-30'),('xinji134','信计134','广东省','仲恺农业工程学院','计算科学学院','信息与计算科学','2013-09-01','2017-06-30'),('xinji135','信计135','北京市','仲大','计算科学学院','信息与计算科学','2013-09-01','2017-06-30');
...
INSERT INTO `anonymous_course` VALUES (4,'测试课程1','2017-04-08',1,'test1','teacher001'),(6,'测试课程2','2016-09-01',1,'test1','teacher001');
...
INSERT INTO `anonymous_finish` VALUES (1,'2017-04-08 15:03:33',0,'/data/vic/aaa','201321314300',2);
...
INSERT INTO `anonymous_student` VALUES ('201321314300','victor李',1,'xinji133');
...
INSERT INTO `anonymous_task` VALUES (2,'test_task1','2017-04-17 14:56:23','2017-04-08 14:57:10',3,4);
...
INSERT INTO `anonymous_teacher` VALUES ('teacher001','凌凌依',0),('test_teacher001','凌凌依',0);
...
INSERT INTO `anonymous_user` VALUES ('s0','1',2,'201321314300','s0@s0.s0','2017-04-08 14:23:19','001');
...
INSERT INTO `django_admin_log` VALUES (1,'2017-04-08 14:09:25','1','Admin object',1,'[{\"added\": {}}]',7,1),(2,'2017-04-08 14:21:10','201321314300','201321314300',1,'[{\"added\": {}}]',12,1),(3,'2017-04-08 14:21:56','teacher001','teacher001',1,'[{\"added\": {}}]',11,1),(4,'2017-04-08 14:23:19','s0','User object',1,'[{\"added\": {}}]',8,1),(5,'2017-04-08 14:32:56','test1','test1',1,'[{\"added\": {}}]',14,1),(6,'2017-04-08 14:37:58','4','4 测试课程1',1,'[{\"added\": {}}]',13,1),(7,'2017-04-08 14:50:34','6','6_测试课程2',1,'[{\"added\": {}}]',13,1),(8,'2017-04-08 14:52:40','test_teacher001','test_teacher001',2,'[{\"changed\": {\"fields\": [\"teacher_id\"]}}]',11,1),(9,'2017-04-08 14:57:10','2','2:test_task1',1,'[{\"added\": {}}]',9,1),(10,'2017-04-08 15:03:33','1','Finish object',1,'[{\"added\": {}}]',10,1);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(7,'anonymous','admin'),(14,'anonymous','clazz'),(13,'anonymous','course'),(10,'anonymous','finish'),(12,'anonymous','student'),(9,'anonymous','task'),(11,'anonymous','teacher'),(8,'anonymous','user'),(4,'auth','group'),(2,'auth','permission'),(3,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session');
...
-- Dump completed on 2017-04-08 23:54:56
